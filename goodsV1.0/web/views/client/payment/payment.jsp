...
<section>
	<div class="top">
		...
		<!--주문/결제-->
		<h1
			style="font-size: 28px; text-align: center; padding-top: 60px; padding-bottom: 60px; color: rgb(25, 25, 25); font-weight: normal;">주문/결제</h1>
		<!--주문/결제메뉴바-->
		<div class="step-wrap">
			<div class="step-step1">
				<span style="padding-left: 100px; padding-right: 21px;">01.
					장바구니</span> <span style=>></span> <span
					style="color: black; font-size: 20px; padding-left: 10px; padding-right: 20px; font-weight: 900; padding-bottom: 16.5px; padding-top: 17px;">02.
					주문/결제</span> <span style=>></span> <span
					style="padding-right: 100px; padding-left: 21px;">03. 주문완료</span>
			</div>
		</div>
	</div>
	<form id="paymentOrder"
		action="<%=request.getContextPath()%>/payment/paymentOrder"
		method="post">
		<div class="middle">
					...
					<tbody>
						...
						<tr class="basketbottom">
							...
							<td class="product">
								...
								<div class="date"
									style="padding: 20px 0 0 0; color: #99844b; font-size: 12px;">
									<span>GoodGoods</span>
								</div>
							</td>
							<td><span class="format-comar"><%=quan[j]%>개</span> <input
								type="hidden" name="pQuan" value="<%=quan[j]%>"></td>
							...
							<td style="font-size: 15px; font-weight: bold;"><span
								class="format-comar"><%=quan[j] * c.getcPrice()%> </span><input
								type="hidden" name="totalPrice"
								value="<%=quan[j] * c.getcPrice()%>">원</td>
						</tr>
						<%
							j++;
						%>
					...
					<li class="order-buyer-wrap dropdown">
						...
						<div class="bottomInform" style="display: block;">
									...
									<tr>
										...
										<td>
											...
											<ul class="phone-numbers">
												...
												<li>
													<div class="input-box-small">
														<input class="pilsu" name="userPhone2[0]"
															id="userPhone2[0]" maxlength="4">
													</div>
												</li>
												<!-- 핸드폰 - 경계선 -->
												<li class="line">-</li>
												...
												<li>
													<div class="input-box-small">
														<input class="pilsu" name="userPhone2[1]"
															id="userPhone2[1]" maxlength="4">
													</div>
												</li>
												<!-- 핸드폰 - 경계선 -->
												<li class="line">-</li>
												...
												<li>
													<div class="input-box-small">
														<input class="pilsu" name="userPhone2[2]"
															id="userPhone2[2]" maxlength="4">
													</div>
												</li>
											</ul>
										</td>
							...
							<span
								...
								<!-- 다음버튼 -->
								<button type="button" class="btn-black-medium"
									style="float: right;" onclick="pilsuInput();">다음</button>
							</span>
						</div>
					</li>
					<li class="dropdown">
						...
						<div class="bottomInform">
								...
								<tbody>
									<tr>
										...
										<td>
											...
											</div> <!-- 원 --> <span style="padding-right: 6px;">원</span> <!-- 쿠폰변경 버튼 및 스타일 -->
											<button type="button" class="btn-white"
												style="background-color: rgb(243, 243, 243); color: #999; margin-right: 10px;">쿠폰변경</button>
											<!-- 사용가능 쿠폰 문구 --> <span
											style="display: inline-block; color: #999; line-height: 34px;">
									...
									<tr>
										...
										<td>
											...
											</div> <span style="padding-right: 6px;">원</span> <!-- 전액사용 버튼 및 스타일 -->
											<button type="button" class="btn-white"
												style="background-color: rgb(243, 243, 243); color: #999; margin-right: 10px;">전액사용</button>
											<!-- (보유 굿머니 문구) --> <span
											style="display: inline-block; color: #999; line-height: 34px;">
												(보유 굿굿즈 머니 <em>0원</em>)
										</span>
									...
									<tr>
										...
										<td>
											...
											</div> <span style="padding-right: 6px;">원</span> <!-- 쿠폰변경 버튼 및 스타일 -->
											<button type="button" class="btn-white"
												style="background-color: rgb(243, 243, 243); color: #999; margin-right: 10px;">쿠폰변경</button>
											<!-- (사용쿠폰 문구) --> <span
											style="display: inline-block; color: #999; line-height: 34px;">
							...
							<span style="height: 40px; line-height: 40px; font-size: 12px;">
								기본배송비는 2,500원이며, <em>총 결제 금액이 50,000원 이상일 경우 무료배송입니다.</em>
							</span>
							<!-- 다음버튼 -->
							<span
								...
								<!-- 다음버튼 -->
								<button type="button" class="btn-black-medium"
									onclick="pilsuInput();" style="float: right;">다음</button>
							</span>
						</div>
					</li>
					<li class="dropdown">
							...
							<table style="margin-top: 0;">
								...
								<tbody>
									...
									<tr class="choice">
										<td>
											<div class="radio">
												<label> <input type="radio" name="payChoice"
													value="card"> 신용카드
												</label>
											</div>
										</td>
				...
				<div>
					...
					<div id="finalPayment"
							...
							<table>
								...
								<thead>
									...
									<tr style="line-height: 90px; border-bottom: 1px solid black;">
										...
										<td style="text-align: right; font-size: 25px; color: #e8625a">
											...
											value="<%=totalPrice%>"> <span class="format-comar"
											style="color: red"><%=totalPrice%></span><span
											style="color: red">원</span>
										</td>
									</tr>
								</thead>
								...
								<tbody style="padding: 40px 0;" class="paymentTextaline">
									...
									<tr style="line-height: 40px;">
										...
										<td style="padding-top: 30px;"><span class="format-comar"><%=price%></span>원</td>
									</tr>
									<!-- 할인금액 -->
									<tr style="line-height: 40px;">
										<th>할인 금액</th>
									...
									<tr style="line-height: 40px;">
										...
										<td style="padding-bottom: 30px;"><span
											class="format-comar"><%=deliveryPay%></span>원</td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div style="background-color: #fafafa;">
							...
							<!-- 결제하기 버튼 클릭 -->
							<button type="button" id="paymentBt" onclick="payment()"
								style="width: 100%; height: 60px; color: #ccc; line-height: 60px; text-align: center; font-size: 18px; border-top: 1px solid rgb(220, 220, 220); font-weight: bold;">결제하기</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="modal-payPolicy animate">
			<div class="url-html">
				<object type="text/html"
					style="margin: 0; padding-right: 0; position: absolute; height: 570px; width: 100%; right: 15px;"
					data="<%=request.getContextPath()%>/views/client/popup/usePolicy.html"
					id="htmlPolicy"></object>
			</div>
			<div class="close-btn">
...
.modal-payPolicy {
	...
	<script>
		...
		function openPayPolicy() {
			...
			$("#poliycheckbox").css('display', 'block');
		}
		// 이용약관 닫기
							...
							function() {
								if ($(inputPilsu[0]).val() == ""
									...
									if ($(this).val() == "") {
										...
										if ($(this).attr('name') == "userPhone2[2]"
												&& $(this).val().length < 4) {
											//input name이 "userPhone[2]" 이고 input 값이 3자리 이하일때
											$(this).addClass('error');
											// input안에 error클래스 추가 해줌
								...
								//input밑에 span경고창(있을때) 삭제
									...
									let emailRule = /(?=^\w+@[a-zA-Z]+[.][a-zA-Z.]+$).{5,}/i;
		...
		function Copy() {
			...
			document.getElementById("userPhone2[0]").value = document
					.getElementById("userPhone[0]").value;
			//id가 userPhone[0]에 입력한 value값을 id가 userPhone2[0]에 value값을 넣어줌
			document.getElementById("userPhone2[1]").value = document
					.getElementById("userPhone[1]").value;
			//id가 userPhone[1]에 입력한 value값을 id가 userPhone2[1]에 value값을 넣어줌
			document.getElementById("userPhone2[2]").value = document
					.getElementById("userPhone[2]").value;
		...
		function pilsuInput() {
			...
			if ($(inputPilsu[0]).val() == "" || $(inputPilsu[1]).val() == ""
				...
				$(event.target).parentsUntil('li').parent().next().children(
						'.bottomInform').slideDown(500);
				
				$(event.target).parentsUntil('.bottomInform').parent().slideUp(
						500);
		...
		function payment() {
			...
			if ($(inputPilsu[0]).val() == "" || $(inputPilsu[1]).val() == ""
				...
				for (let i = 0; i < inputPilsu.length; i++) { //일단 입력창갯수 만큼 for문 돌리긔
					...
					if ($(inputPilsu[i]).attr('name') == "userPhone[2]"
							&& $(inputPilsu[i]).val().length < 4) {
						$(inputPilsu[i]).siblings('span').remove();
						//input name이 "userPhone[2]" 이고 input 값이 3자리 이하일때
						...
						$(inputPilsu[i])
								.after(
										$('<span>').html("최소 4자리이상.").addClass(
												'error'));
						// input다음에 span을 넣어줌 html(내용).addclass는(css
					}

					if ($(inputPilsu[i]).attr('name') == "userPhone2[2]"
							&& $(inputPilsu[i]).val().length < 4) {
						$(inputPilsu[i]).siblings('span').remove();
						//input name이 "userPhone[2]" 이고 input 값이 3자리 이하일때
						$(inputPilsu[i]).addClass('error');
				...
				if ($(inputPilsu[3]).attr('name') == "userPhone[2]"
						&& $(inputPilsu[3]).val().length < 4) {
					...
					// input안에 error클래스 추가 해줌
					$(inputPilsu[3]).after(
							$('<span>').html("최소 4자리이상.").addClass('error'));
					// input다음에 span을 넣어줌 html(내용).addclass는(css
				} else if ($(inputPilsu[8]).attr('name') == "userPhone2[2]"
						&& $(inputPilsu[8]).val().length < 4) {
					...
					$(inputPilsu[8]).after(
							$('<span>').html("최소 4자리이상.").addClass('error'));
					// input다음에 span을 넣어줌 html(내용).addclass는(css
				} else if (!emailRule.test($("#userEmail").val())) {
					if (!emailRule.test($("#userEmail").val())) { //이메일 유효성 검사하고 결과 이상하면
