...
<section class="backs" style="border:1px solid red; text-align:center;">
	...
	<div id="outer-container" style="border:1px solid black">
		...
		<% for(Product p : list){ %>
		     <div class="inner-container" onclick="location.href='<%=request.getContextPath()%>/product/view?pNo=<%=p.getpNo()%>'">
		     	<img src="<%=request.getContextPath()%>/images/product/thumbnail/<%=p.getpThumbnail() %>" width="300px" alt="">
