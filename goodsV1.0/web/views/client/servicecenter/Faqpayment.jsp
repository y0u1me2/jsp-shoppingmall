    ...
    <section>
        ...
        <div class="aside">
            ...
            <ul class="lnb_list">
                ...
                <li><a href="<%=request.getContextPath() %>/faqPay?cg=FAQ_1" style="color: #0E0E0E; font-weight: bolder;">FAQ</a></li><br />
        ...
        <div class="faqmiddle">
			...
			<form>
            <div style=" background-color: #E7ECF0; padding-top: 10px; padding-bottom: 15px;">
            ...
            <div style="display: flex; flex-wrap: wrap; background-color: rgb(233, 232, 232);">
                ...
                <div class="hor2">
                    <a href="<%=request.getContextPath() %>/faqPay?cg=FAQ_3">주문</a></div>
                <div class="hor2" style="background-color: rgb(240, 226, 226); ">
                    <a href="<%=request.getContextPath() %>/faqPay?cg=FAQ_4" style="color: rgb(196, 143, 196);">결제</a></div>
