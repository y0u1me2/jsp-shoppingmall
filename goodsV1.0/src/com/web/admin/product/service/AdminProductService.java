...
public class AdminProductService {
	...
	private ProductDao dao2 = new ProductDao();
...
//상품색상삭제 화면 출력==========================================
	public LinkedHashMap<String, String> SearchProductNo(int no) {
		Connection conn = getConnection();
	
		LinkedHashMap<String, String> images = dao2.getProductImages(conn,no);
		close(conn);
...
//상품색상 삭제================================================
	public int colorDelete(int no, String[] color) {
		Connection conn = getConnection();

		int result = dao.colorDelete(conn, no, color);
